...
<body class="text-center">
    <div class="container-fluid mx-auto w-50 cabeca row navbar navbar-expand-sm px-5">
        ...
        <ul class="navbar-nav col-sm-6">
            <li class="nav-item">
                <a class="nav-link" href="index.php">Já tem uma conta? Faça login!</a>
            </li>
        </ul>
    </div>

    <form class="w-50 mx-auto mt-5 p-5 shadow rounded fundoForm clearfix" action="areaSeguraCadastro.php" method="POST">
