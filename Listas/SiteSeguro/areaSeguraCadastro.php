...
$consulta = "INSERT INTO login(usuario, senha) VALUES(\"$usuarioForm\", \"$senhaForm\")";
...
if ($resultado) {
    $saidaUsuario .= " bg-success'>" . $usuarioForm . " inserido com sucesso!!!</h1>";
} else {
    $saidaUsuario .= " bg-danger'>Não foi possível te cadastrar</h1>";
}
...
<body class="text-center">
    <div class="container-fluid mx-auto w-50 cabeca row navbar navbar-expand-sm px-5">
        <h3 class="navbar-text col-sm-6">Cadastro</h3>

        <ul class="navbar-nav col-sm-6">
            <li class="nav-item">
                <a class="nav-link" href="criarUsuario.php">Voltar</a>
            </li>
        </ul>
    </div>
