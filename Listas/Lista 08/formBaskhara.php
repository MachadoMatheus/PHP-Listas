...
<body> 
	...
	<?php 
		...
		$conteudoEsquerda[] = 
		"<form method='POST' action='baskhara.php'>
		<label class='textTitulo' for='a'>Valor de a</label><br>
		<input type='number' id='a' name='a' size='10' placeholder='Digite o Valor de a..'>	<br>
		<label class='textTitulo' for='b'>Valor de b</label>
		<input type='number' name='b' id='b' size='10' placeholder='Digite o Valor de b..'>
		<label class='textTitulo' for='c'>Digite o Valor de c</label>
		<input type='number' name='c' id='c' size='10' placeholder='Digite o Digite o Valor de c..'>
